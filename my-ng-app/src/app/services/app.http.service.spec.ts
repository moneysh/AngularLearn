...
// successfully
    ...
    it('should provide injector type',()=>{
        
        inject([HttpService], (httpServ:HttpService)=>{
            expect(httpServ).toBe(httpService);
        });
    });
...
//   // actual test cases
  ...
  it('postData() sould POST and return Product', () => {
    ...
    prd.ProductRowId = 0;
    prd.ProductId = 'Prd-088';
    prd.ProductName = 'Note Book';
    prd.CategoryName = 'Stationary';
    prd.Manufacturer = 'GHS';
    prd.Description = '222 PAges';
    prd.BasePrice = 78;
    // act
